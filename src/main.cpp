...
uint256 hashGenesisBlock("0x9b57ae251edfd669768c64e8d135c6bf24fde19b09662d3f6de138ab26f0ed36");
...
const string strMessageMagic = "ZzCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ZzCoin: 1 days
static const int64 nTargetSpacing = 120; // ZzCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal zzcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZzCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2ebc52d9213980c8d10a0e41123b5bdcc5ce9c398c9ccf1dff1e81bc2c88b3ff");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "fdfdfdsfdsfdsdfsdfsdfds";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387448247; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 323804;

        if (fTestNet)
        {
            block.nTime    = 1387444486;
            block.nNonce   = 1440363;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc39f29fc6185393f94f23c74d950b4c81644abd48c1cb476c236b9773c10cca1"));
